...
CREATE TABLE app_fp.fop (
    ...
    create_date                timestamp(6)    TIMESTAMP(6) WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP NOT NULL,
    update_user                varchar(30),
    update_date                timestamp(6)    TIMESTAMP(6) WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP 
)
;
